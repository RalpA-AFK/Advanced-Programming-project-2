public class Main {
    ...
    public static void testAddLast(){
        ...
        System.out.println("What is the last integer in the array? " + list.baseArray[size - 1]); // will be 50
        list.addLast(60);
        size = list.size;
        System.out.println("What is the last integer in the array? " + list.baseArray[size - 1]); // will be 60
    }
    ...
    public static void testInsertAt(){
        ...
        System.out.println("What is the integer at index 3? " + list.baseArray[3]); //will be 30
    }
    public static void testRemoveFirst(){
        DynamicArray<Integer> list = new DynamicArray<>(); //populate the list
        list.addLast(10); list.addLast(20); list.addLast(30); list.addLast(40); list.addLast(50);
        System.out.println("--- Testing removeFirst ---");
        System.out.println("What is the integer at index 0 in the array? " + list.baseArray[0]); // will be 10
        list.removeFirst();
    ...
    public static void testRemoveAt(){
        ...
        System.out.println("What is the integer at index 2 in the array? " + list.baseArray[2]); // will be 30
        list.removeAt(2);
        System.out.println("What is the integer at index 2 in the array? " + list.baseArray[2]); // will be 40
    }
    ...
    public static void testToArray(){
        ...
        System.out.println("What are the contents of the array? " + list.toArray());
    }
